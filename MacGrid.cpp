...
MacGrid::MacGrid(
    ...
    _vel_x_front_buffer = std::make_unique< Grid<float> >
        (size_x, size_y, _DELTA_X, _DELTA_Y);
    _vel_y_front_buffer = std::make_unique< Grid<float> >
        (size_x, size_y, _DELTA_X, _DELTA_Y);
    _temperature_front_buffer = std::make_unique< Grid<float> >
        (size_x, size_y, _DELTA_X, _DELTA_Y);
    _concentration_front_buffer = std::make_unique< Grid<float> >
        (size_x, size_y, _DELTA_X, _DELTA_Y);
    _vel_x_back_buffer = std::make_unique< Grid<float> >
        (size_x, size_y, _DELTA_X, _DELTA_Y);
    _vel_y_back_buffer = std::make_unique< Grid<float> >
        (size_x, size_y, _DELTA_X, _DELTA_Y);
    _temperature_back_buffer = std::make_unique< Grid<float> >
        (size_x, size_y, _DELTA_X, _DELTA_Y);
    _concentration_back_buffer = std::make_unique< Grid<float> >
        (size_x, size_y, _DELTA_X, _DELTA_Y);
...
void MacGrid::swapTemperatureBuffers() {
    _temperature_front_buffer.swap(_temperature_back_buffer);
}

void MacGrid::swapConcentrationBuffers() {
    _concentration_front_buffer.swap(_concentration_back_buffer);
}